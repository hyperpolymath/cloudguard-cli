...
# cloudguard-cli container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping cloudguard-cli..."
...
echo "Starting cloudguard-cli..."
echo "  Host: ${APP_HOST:-[::]}"
echo "  Port: ${APP_PORT:-3846}"
...
# Examples:
#   exec /app/cloudguard-cli
#   exec /app/release/bin/cloudguard-cli start
#   exec /app/cloudguard-cli serve --host "${APP_HOST}" --port "${APP_PORT}"
