...
[arabic]
. Navigate to
https://github.com/hyperpolymath/cloudguard-cli/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |link:NONE[Download Public Key]
|*Fingerprint* |`+NONE+`
|===
...
https://github.com/hyperpolymath/cloudguard-cli/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/cloudguard-cli/discussions[GitHub
Discussions]
...
_Thank you for helping keep cloudguard-cli and its users safe._ 🛡️
