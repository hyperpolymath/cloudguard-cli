...
sed -i "s/2026-03-02/$(date +%Y-%m-%d)/g" $(grep -rl '2026-03-02' .)
```
...
| `J.D.A.J.` | Author initials (for citations) | `J.` | docs/CITATIONS.adoc |
...
| `2026-03-02` | Current date (ISO) | `2026-02-14` | STATE.a2ml, MAINTAINERS.md |
| `2026-03-02` | Last updated date | `2026-02-14` | TOPOLOGY.md, THREAT-MODEL.md |
