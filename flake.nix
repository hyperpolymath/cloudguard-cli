...
#
# TODO: Replace cloudguard-cli and CloudGuard CLI — standalone Cloudflare domain security management tool with actual values.

{
  description = "cloudguard-cli — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          env = {
            PROJECT_NAME = "cloudguard-cli";
            RSR_TIER = "infrastructure";
          };

          shellHook = ''
            echo ""
            echo "  cloudguard-cli — development shell"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for cloudguard-cli"
          '';
          ...
          meta = with pkgs.lib; {
            description = "CloudGuard CLI — standalone Cloudflare domain security management tool";
