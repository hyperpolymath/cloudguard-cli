...
Replace all PLACEHOLDER values with your information:
  cloudguard-cli     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  cloudguard-cli             - Repository name
  j.d.a.jewell@open.ac.uk   - Security contact email
  NONE  - Your PGP key fingerprint (40 chars, no spaces)
  NONE      - URL to your public PGP key
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/cloudguard-cli/security/advisories/new)
...
| **PGP Key** | [Download Public Key](NONE) |
| **Fingerprint** | `NONE` |

```bash
# Import our PGP key
curl -sSL NONE | gpg --import
...
- This repository (`hyperpolymath/cloudguard-cli`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/cloudguard-cli/security/advisories)
...
When using cloudguard-cli, we recommend:
...
- [Our PGP Public Key](NONE)
- [Security Advisories](https://github.com/hyperpolymath/cloudguard-cli/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/cloudguard-cli/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/cloudguard-cli/discussions) |
...
*Thank you for helping keep cloudguard-cli and its users safe.* 🛡️
