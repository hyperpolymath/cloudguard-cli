...
|SSL/TLS |Full strict mode, TLS 1.2 minimum, always HTTPS, auto
rewrites, opportunistic encryption, TLS 1.3 |CRITICAL–LOW

|Security Headers |HSTS with preload, subdomains, nosniff |HIGH

|WAF & Bot Defense |Browser check, hotlink protection, email
obfuscation, security level |MEDIUM–LOW
