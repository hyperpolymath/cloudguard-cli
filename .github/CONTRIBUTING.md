...
git clone <https://github.com/hyperpolymath/cloudguard-cli.git> cd
cloudguard-cli
...
toolbox create cloudguard-cli-dev toolbox enter cloudguard-cli-dev \#
...
cloudguard-cli/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/cloudguard-cli/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/cloudguard-cli/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/cloudguard-cli/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/cloudguard-cli/labels/perimeter-3) — Community sandbox scope
